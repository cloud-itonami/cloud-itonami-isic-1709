# Operator Quickstart — Manufacture of other articles of paper and paperboard

Shortest path from clone to a verified local dry-run for **ISIC 1709** (`cloud-itonami-isic-1709`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1709.git
cd cloud-itonami-isic-1709
```
...
- Blueprint governor key: `paper-articles-plant-operations-governor`
- Likely source path: `paperarticles.governor.cljc`
