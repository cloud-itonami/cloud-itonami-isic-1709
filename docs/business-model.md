# Business Model: Manufacture of other articles of paper and paperboard
...
## Classification
- Repository: `cloud-itonami-isic-1709` ([github.com/cloud-itonami/cloud-itonami-isic-1709](https://github.com/cloud-itonami/cloud-itonami-isic-1709))
- ISIC Rev.5: `1709` — Manufacture of other articles of paper and paperboard
- Domain: `:paper-articles/plant-operations`
- Social impact: :worker-safety :environmental-stewardship :resource-efficiency
- Actor: `:paper-articles-plant-operations-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :paper-articles/plant-operations — who wants
...
One managed tenant (:paper-articles/plant-operations):
...
- Do not bypass the `:paper-articles-plant-operations-governor` for production decisions.
