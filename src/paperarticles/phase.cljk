(ns paperarticles.phase
  "Phase 0->3 staged rollout for the ISIC 1709 (other paper and
  paperboard articles) plant-operations coordination actor.
  ...
  consequence (a pulp-molding-press/die-cutter/converting-line
  maintenance window means production downtime, and the equipment
  ends up actually touched); it is always a human plant supervisor's
  call. `paperarticles.governor`'s `equipment-control-blocked-
  violations` HARD-blocks direct-actuation attempts unconditionally,
...
(defn verdict->disposition
  "Map a Paper Articles Plant Operations Governor verdict to a base
